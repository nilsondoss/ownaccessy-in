...
export const viteServerAfter = (server, viteServer) => {
  ...
  server.use((req, res, next) => {
    ...
    // Common extensions: .js, .css, .png, .jpg, .svg, .ico, .json, etc.
    ...
    // For all other GET requests, let Vite handle the index.html transformation
    // This supports client-side routing with React Router
    req.url = '/index.html';
    next();
  });
